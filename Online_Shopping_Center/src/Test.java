public class Test {
    public static void main(String[] args) {
        ...
        Electronics e1 = new Electronics("z1","dphone",10,100,"apple",20);
        Electronics e2 = new Electronics("w2","atab",1,100,"samsung",20);
        Clothing c1 = new Clothing("h1","cshirt",2,30,"small","black");
        Clothing c2 = new Clothing("a2","bshort",15,34,"xl","yellow");
